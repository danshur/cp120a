...
public class LambdaExercise {
	...
	public static void main(String[] args) {
		...
		// hint the expression can be found in the LambdaTest.java from the
		// book.
		...
		// hint use new StringBuilder(first).reverse().toString() to reverse the
		// string
		System.out.println("Sorted in dictionary order of the reversed name (ascending)");
		Arrays.sort(planets, (a, b) -> new StringBuilder(a).reverse().toString()
		...
		Arrays.sort(planets, (a, b) -> new StringBuilder(b).reverse().toString()
				.compareTo(new StringBuilder(a).reverse().toString()));
		System.out.println(Arrays.toString(planets));
	}
}
